	...
	<div class="row-md-6">
		<div class="card">
			...
			<div style="display: grid; grid-template-columns: 30% 60%">
				<label>Day</label>
				<input class="form-control" value="${currentDay }" id="i_day" type="number" min="1" max="31"/>
				<label>Month</label>
				<input class="form-control" value="${currentMonth }" id="i_month" type="number" min="1" max=""/>
				<label>Year</label>
				<input class="form-control" value="${currentYear }" id="i_year" type="number"/>
	...
	<div class="row-md-6">
		<div class="card">
			...
			<div style="display: grid; grid-template-columns: 30% 60%">
				...
				<input disabled="disabled" class="form-control" value="0" id="o_income" />
				<label>Spent</label>
				<input disabled="disabled" class="form-control" value="0" id="o_spent" />
				<label>Balance</label>
				<input disabled="disabled" class="form-control" value="0" id="o_balance" />
			</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function init(){
		byId("btn-submit").onclick = function(e){submit();}
	}
