...
<body><noscript>You need to enable JavaScript to run this app.</noscript><input type="hidden" id="rootPath" value="${contextPath}"/>
	...
	<script src="<c:url value="/res/react-resources/static/js/1.b22c4682.chunk.js" />"></script>
	<script src="<c:url value="/res/react-resources/static/js/main.b5efa7ed.chunk.js" />"></script>
</body>
