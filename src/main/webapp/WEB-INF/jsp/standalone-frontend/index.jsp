...
<head>
	...
	<title>${title }</title>
	<link href="<c:url value="/res/react-resources/static/css/main.ac5c60b8.chunk.css" />" rel="stylesheet">
</head>
...
<body><noscript>You need to enable JavaScript to run this app.</noscript><input type="hidden" id="rootPath" value="${contextPath}"/>
	...
	<script src="<c:url value="/res/react-resources/static/js/1.9aebe825.chunk.js" />"></script>
	<script src="<c:url value="/res/react-resources/static/js/main.9a9d0d89.chunk.js" />"></script>
</body>
