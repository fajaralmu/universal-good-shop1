...
public class JwtUtil {
	...
	public static String generateJWT(SessionData sessionData, UserSessionModel account) {
	...
	public static UserSessionModel getRegisteredRequest(String jwt) {
		...
		try {
			return mapper.readValue(payloadDecoded, UserSessionModel.class);
		} catch (JsonProcessingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			return null;
	...
	public static void main(String[] args) {
		String jwt = generateJWT(new SessionData(), new UserSessionModel());
