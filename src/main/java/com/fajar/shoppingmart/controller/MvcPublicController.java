...
public class MvcPublicController extends BaseController{ 
	...
	@CustomRequestInfo(title = "Product Catalog", pageUrl = "catalog-component/catalog-page", scriptPaths = {"product-catalog", "product-catalog-display" }, stylePaths = {"filter-box"})
